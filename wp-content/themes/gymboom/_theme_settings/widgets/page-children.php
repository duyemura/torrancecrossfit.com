...
class ThemeWidgetPageChildren extends ThemeWidgetBase {
	function ThemeWidgetPageChildren() {
		$widget_opts = array(
			...
			'description' => __( 'Displays the direct children of the current page ancestor. This widget is displayed only on pages.','gymboom'));
		$control_ops = array();
		$this->WP_Widget('theme-widget-top-level-page-children', __('[GYMBOOM] List Child Pages','gymboom'), $widget_opts, $control_ops);
	}
