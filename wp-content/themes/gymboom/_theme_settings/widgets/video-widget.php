	...
	*/
	function ThemeWidgetVideoItems() {
		...
		$widget_opts = array(
			...
			'description' => __( 'Display one or more recent video items.','gymboom'));
		...
		$this->WP_Widget('theme-widget-videos', __('[GYMBOOM] Video Widget','gymboom'), $widget_opts, $control_ops);
		$this->custom_fields = array(
			array(
				'name'=>'title',
				'type'=>'text',
				'title'=>__('Title','gymboom'), 
				'default'=>__('Videos','gymboom')
			),
			array(
				'name'=>'categories',
				...
				'title'=>__('Video Categories','gymboom'),
				'default'=>''
			),
			array(
				'name'=>'load',
	...
	*/
	function front_end($args, $instance) {
		...
		if ( have_posts() ) :
			...
			?><div class="gallery-widget gallery" rel="<?php echo intval($limit); ?>"><?php
