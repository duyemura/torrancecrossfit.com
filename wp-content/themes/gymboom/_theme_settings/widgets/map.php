	...
	*/
	function ThemeWidgetMapWidget() {
		$widget_opts = array(
			...
			'description' => __( 'Displays a Google Map.','gymboom') );
		...
		$this->WP_Widget('theme-widget-map-widget', __('[GYMBOOM] Google Map Widget','gymboom'), $widget_opts, $control_ops);
		$this->custom_fields = array(
			array(
				'name'=>'title',
				'type'=>'text',
				'title'=>__('Title (optional)','gymboom'), 
				'default'=> ''
			),
			array(
				'name'=>'map_code',
				'type'=>'textarea',
				'title'=>__('Map &lt;iframe&gt; Code','gymboom'), 
