<?php
	...
	$form .= $this->add_wrap('<strong style="padding:20px 0 10px 5px; display:block;">'.__('Hide, display or require form fields.  Hidden fields do not appear in the event form.', AEC_NAME).'</strong>', '<h3 style="padding:0;">', '</h3>');
